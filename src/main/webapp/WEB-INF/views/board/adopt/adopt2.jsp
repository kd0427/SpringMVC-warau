				...
				<section class="share inner scroll-spy">
					...
					<div class="boardcontent back-to-position to-down">
						<c:forEach var='adoptList' items='${adoptList }'>
							<div class="item ">
								<div class="shareImg">
									<a href="${root }board/adopt/read?adopt_idx=${adoptList.adopt_idx}"><img src="${root }upload/${adoptList.adopt_img}" alt=""></a>
								</div>
								<div class="shareText">
									<div>${adoptList.adopt_title }</div>
									<div>${adoptList.adopt_writer }</div>
								</div>
							</div>
						</c:forEach>
					</div>

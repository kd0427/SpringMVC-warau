			...
			<div class="card shadow">
				<div class="card-body">
					<div class="form-group">
						...
						<input type="text" id="board_writer_name" name="board_writer_name" class="form-control" value="${readAdoptVO.adopt_writer}" disabled="disabled"/>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="text-right">
							...
							<c:if test="${loginUserVO.user_id == readAdoptVO.adopt_writer}">
								<a href="${root }board/adopt/modify?adopt_idx=${adopt_idx}" class="btn btn-info">수정하기</a>
								<a href="${root }board/adopt/delete?adopt_idx=${adopt_idx}" class="btn btn-danger">삭제하기</a>
							</c:if>
						</div>
					</div>
				</div>

...
<body>
		...
		<div class="page-title">
			<div class="row gutters">
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
					<input type="text"
						id="receiver-id" placeholder="상대방 아이디를 입력하세요" />
    ...
    function init(){
      ...
      peer.on('connection', function(con2){
        ...
        conn = con2;
        $('#status').html(conn.peer + " 님과 연결 되었습니다.");
        ready();
      });
    ...
    function join(){
      ...
      conn = peer.connect($('#receiver-id').val()); //입력한 아이디
      ...
      if(side == 'left'){
        msgHtml.push('<li class="chat-left">');
          msgHtml.push('<div class="chat-avatar">');
            ...
            msgHtml.push('<div class="chat-name">${chatId }</div>');
          msgHtml.push('</div>');

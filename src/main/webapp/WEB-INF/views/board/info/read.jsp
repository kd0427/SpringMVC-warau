			...
			<div class="card shadow">
				<div class="card-body">
					<div class="form-group">
						...
						<input type="text" id="board_writer_name" name="board_writer_name" class="form-control" value="${readInfoVO.info_writer}" disabled="disabled"/>
					</div>
					<div class="form-group">
						<label for="board_date">작성날짜</label>
						<input type="text" id="board_date" name="board_date" class="form-control" value="${readInfoVO.info_regdate }" disabled="disabled"/>
					</div>
					<div class="form-group">
						<label for="board_subject">제목</label>
						<input type="text" id="board_subject" name="board_subject" class="form-control" value="${readInfoVO.info_title }" disabled="disabled"/>
					</div>
					<div class="form-group">
